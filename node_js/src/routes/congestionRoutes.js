...
/**
 * @swagger
 * /congestion/shuttle/overview:
 *   get:
 *     summary: 셔틀버스 혼잡도 대시보드 조회
 *     tags: [Congestion]
 *     security:
 *       - bearerAuth: []
 *     description: >
 *       집계된 혼잡도 스냅샷을 기반으로,
 *       특정 날짜의 셔틀버스 노선별·출발 시간대별 혼잡도 정보를 조회합니다.
 *       대시보드 화면(셔틀버스 혼잡도 카드 리스트)에서 사용됩니다.
 *     parameters:
 *       - in: query
 *         name: dayKey
 *         schema:
 ...
 *         description: 서버 오류
 */
router.get('/shuttle/overview', authToken, congestionController.getShuttleOverview);
